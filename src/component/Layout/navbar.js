        ...
        <Navbar.Collapse id="navbarSupportedContent">
          <Nav className="me-auto">
            {isAuthenticated && user?.categoria === "admin" && (
              <>
                <Nav.Link as={NavLink} to="/productos" className="nav-link">PANEL</Nav.Link>
                <Nav.Link as={NavLink} to="/" className="nav-link">Inicio</Nav.Link>
                <Nav.Link as={NavLink} to="/about" className="nav-link">Quienes Somos</Nav.Link>
                <Nav.Link as={NavLink} to="/acerca_de" className="nav-link">Lista de comentarios</Nav.Link>
                <NavDropdown title="Opciones" id="navbarDropdown">
            ...
            {isAuthenticated && user?.categoria === "cliente" && (
              <>
                <Nav.Link as={NavLink} to="/" className="nav-link">Inicio</Nav.Link>
                <Nav.Link as={NavLink} to="/about" className="nav-link">Quienes Somos</Nav.Link>
                <Nav.Link as={NavLink} to="/contacto" className="nav-link">Contactanos</Nav.Link>
                <Nav.Link as={NavLink} to="/productos" className="nav-link">Catálogo</Nav.Link>
                <NavDropdown title="Ajustes" id="navbarDropdown">
                  <NavDropdown.Item as={Link} to="#" onClick={() => buscarUsuario()}>Editar Mis Datos</NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/darme_de_baja">Darme de Baja</NavDropdown.Item>
                  <NavDropdown.Divider />
            ...
            {!isAuthenticated && (
              <>
                ...
                <Nav.Link as={NavLink} to="/contacto" className="nav-link">Contactanos</Nav.Link>
                <Nav.Link as={NavLink} to="/productos" className="nav-link">Catálogo</Nav.Link>
                <Nav.Link as={NavLink} to="/users/login" className="nav-link">Cuenta</Nav.Link>
              </>
            )}
          </Nav>
          <Form className="d-flex" role="search">
